...
125 native checks, including lost-target and cleanup behavior. Main-scene resource
loading, actor-signal connection and server damage integration remain pending.
