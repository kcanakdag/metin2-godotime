...
qualify Dash chasing a moving Brown Bear. The populated Yongan town replay now
passes 23 browser checks with visible Dash effects on both clients, after fixing
visual events lost between state updates. Browser moving-target and streamed
boundary acceptance remain pending.
